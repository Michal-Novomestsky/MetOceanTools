...
import numpy as np
import COARE.COARE3_6.coare36vn_zrf_et as c36
import os
...
#	    LW_dn = downward IR flux (w/m^2) defined positive down #TODO: Don't have. Currently assuming it's = SW_dn. May be possible to use SW_dn to calibrate spectral radiance curve and get IR band?
#	    Lat = latitude (deg N=+)
...
#       cp = phase speed of dominant waves (m/s) #TODO: Can probably just assume that it's the wavespeed of the peak in wave FFT - not necessary function parameter
#       sigH = significant wave height (m) #TODO: Unsure how to correlate peak of FFT to its associated amplitude - not necessary function parameter
